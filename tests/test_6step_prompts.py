...
def test_all_prompts_format():
    ...
    prompts = [
        ...
        prompt.plan_trajectory_system_prompt,
        prompt.plan_trajectory_user_prompt,
        prompt.plan_evaluation_system_prompt,
        prompt.plan_evaluation_user_prompt,
        prompt.execute_plan_preapproved_prompt,
        prompt.execute_plan_evidence_section_prompt,
        prompt.execute_plan_final_answer_prompt,
        prompt.planned_tool_message_template,
    ...
    for name, text in [
        ...
        ("plan_trajectory_system_prompt", prompt.plan_trajectory_system_prompt),
        ("plan_trajectory_user_prompt", prompt.plan_trajectory_user_prompt),
        ("plan_evaluation_system_prompt", prompt.plan_evaluation_system_prompt),
        ("plan_evaluation_user_prompt", prompt.plan_evaluation_user_prompt),
        ("execute_plan_preapproved_prompt", prompt.execute_plan_preapproved_prompt),
        ("execute_plan_evidence_section_prompt", prompt.execute_plan_evidence_section_prompt),
        ("execute_plan_final_answer_prompt", prompt.execute_plan_final_answer_prompt),
